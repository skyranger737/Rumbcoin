...
unsigned int nTargetSpacing_v2 = 150; //2 minute and 30s
...
const string strMessageMagic = "Rumbcoin Signed Message:\n";
    ...
    int64_t nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8);
						...
						
  			 {
				nSubsidy = nSubsidy * 0.0001;
                         ...
                         {
                                 nSubsidy = nSubsidy * 100 ;  //10000% Superblocks
                         }
                         ...
                         {
                                 nSubsidy = nSubsidy * 3.5 ;  //350%

                         }
						 
			    else if(nBestHeight <= 1510000)
                         {
                                 nSubsidy = nSubsidy * 100 ;  //10000% Superblocks
                         }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Rumbcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Galaxy Digital and Block.One Lead $30 Million Funding Round for US Disruptor Bank - 11 dez";
        CTransaction txNew;
        txNew.nTime = 1544544736;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1544544736;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 730007 : 730007;

        assert(block.hashMerkleRoot == uint256("0xe7e70a27b77c83c7ada697e018613a33828b93749f74186d9969463104fc1034"));
